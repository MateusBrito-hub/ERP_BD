...
export const createValidation = validation((getSchema) => ({
	body: getSchema<IBodyProps>(yup.object().shape({
		...
		inscricao_estadual: yup.number().optional().default(null),
		inscricao_estadual_ST: yup.number().optional().default(null),
		inscricao_municipal: yup.number().optional().default(null),
